...
"""
            ...
            # Stage 2: Health summary and Pakistani diet plan
            diet_prompt = f"""
...
"""
        ...
        if "SECTION 2" in full_response:
            ...
            diet_plan = ("SECTION 2" + parts[1]).replace("SECTION 2 - PAKISTANI DIET PLAN:", "").replace("SECTION 2", "").strip()
        else:
